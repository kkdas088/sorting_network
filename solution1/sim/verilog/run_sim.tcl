...
set ret [catch {eval exec ./cosim.tv.exe test1 | tee temp0.log >&@ stdout} err]
...
if {[file isfile algo_unpacked.autotvin.dat]} {
	file delete -force algo_unpacked.autotvin.dat
}

if {[file isfile algo_unpacked.autotvout.dat]} {
	file delete -force algo_unpacked.autotvout.dat
}
...
set ret [catch {eval exec ./cosim.pc.exe test1 | tee temp0.log >&@ stdout} err]
