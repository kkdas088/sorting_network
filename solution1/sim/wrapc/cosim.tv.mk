...
$(ObjDir)/algo_unpacked_tb.cpp_pre.cpp.tb.o : algo_unpacked_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling algo_unpacked_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/algo_unpacked.cpp_pre.cpp.tb.o : algo_unpacked.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling algo_unpacked.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
