...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe test1 | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "algo_unpacked.autotvin.dat"
	set constFileTvOut       "algo_unpacked.autotvout.dat"
	set constFileHdlTvIn     "algo_unpacked.autohdltvin.dat"
	set constFileHdlTvOut    "algo_unpacked.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
